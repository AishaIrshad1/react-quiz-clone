...
const ResultScreen = () => {
  ...
  return (
    <div className="p-6 max-w-xl mx-auto text-center text-[#f1f3f5]">
      <div className="bg-[#1098ad] rounded-full py-4 px-6 text-xl font-semibold mb-6 inline-block">
        {emoji} You scored {points} out of {maxPoints} ({Math.round(percentage)}%)
      </div>

      <p className="text-lg mb-4 text-[#ced4da]">(Highscore: {highscore} points)</p>
